...
export default function PlanBanner({
  ...
  return (
    <Card className="border-orange-300/40 bg-linear-to-r from-orange-500/10 to-indigo-500/10">
      <CardContent className="p-5">
        <div className="min-w-0 flex flex-col">
          <div className="flex justify-between">
            ...
            <Link
              href="/billing"
              className="mt-3 inline-flex items-center justify-center rounded-md border border-orange-400/40 bg-card px-4 py-2 text-sm font-semibold text-foreground transition-colors hover:bg-muted"
            >
              Upgrade to Pro →
            </Link>
          </div>
